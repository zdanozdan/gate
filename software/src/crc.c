/**************************************************************************
**                                                                        
**  FILE : $Source: /cvs/cvsrepo/projects/gate/software/src/crc.c,v $
**                                                                        
**  $Author: tomasz $                                                     
**  $Log: crc.c,v $
**  Revision 1.1  2006/12/15 21:35:21  tomasz
**  first release
**
**  
**  COPYRIGHT   :  2006 TZ                                
...
static code unsigned char crc16_tab[256]=
{
...
/**
 * Calculates value of crc 16
 *
 * @param buffer poiner to data buffer
 * @param buff_len buffer size
 * @return crc calculated crc 16 value
 */
unsigned short crc_16(const unsigned char *buffer, const unsigned int buff_len)
{
   ...
   {
      index=buffer[i]^(crc>>8);
      tmp=*(crc16_tab+index);
      crc=((tmp&0xFF00)^(crc<<8))|(tmp&0x00FF);
   }
